      ...
      <div className="container max-w-7xl mx-auto pt-4 pb-8 px-4">
        <div className="mb-6">
          <div className="flex items-start justify-center gap-4 mb-2">
            <DashboardNavigation side="left" previous={{ path: "/constituent-services", label: "Constituent Services" }} />
            ...
            <DashboardNavigation side="right" next={{ path: "/healthcare", label: "Healthcare Access" }} />
          </div>
        </div>
